  ...
  return (
    <div className=" w-16">
      <svg
        ...
        x='0px'
        y='0px'
        viewBox='0 0 531.8 459.4'
        enableBackground='new 0 0 531.8 459.4'
>
        <g>
          <path
            fill='#D51E4A'
            d='M432.7,52.4v26.2h26.2h26.2V52.4V26.2h-26.2h-26.2V52.4z'
          />
          <path
            fill='#D51E4A'
            d='M358.8,77.2v25.5H385h26.2V77.2V51.7H385h-26.2V77.2z'
          />
          <path className="dark:fill-neutral-200"
		...
		C290,86.4,264.9,81.7,246.7,85.8z'
          ...
          <path
            fill='#D51E4A'
            d='M325.2,112.8v12.8h12.1h12.1v-12.8v-12.8h-12.1h-12.1V112.8z'
          />
          <path
            fill='#D51E4A'
            d='M447.5,135.7v35.6h35.6h35.6v-35.6v-35.6h-35.6h-35.6V135.7z'
          />
          <path
            fill='#D51E4A'
            d='M383,151.1v17.5h16.8h16.8v-17.5v-17.5h-16.8H383V151.1z'
          />
          <path
            fill='#D51E4A'
            d='M340,155.8v12.8h12.1h12.1v-12.8v-12.8h-12.1H340V155.8z'
          />
          <path
            fill='#D51E4A'
            d='M315.8,206.2v32.2h32.2h32.2v-32.2V174h-32.2h-32.2V206.2z'
          />
        </g>
      </svg>
    </div>
